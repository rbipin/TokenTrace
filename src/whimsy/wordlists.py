...
SURNAMES: tuple[str, ...] = (
    ...
    "zhukovsky",
    # Jagadish Chandra Bose - Indian polymath physicist, biologist, and botanist who did pioneering research on radio and microwave optics. https://en.wikipedia.org/wiki/Jagadish_Chandra_Bose
    "bose_jc",
    ...
    "ray_pc",
    # Anna Mani - Indian meteorologist and physicist who made major contributions to atmospheric science and solar radiation measurement. https://en.wikipedia.org/wiki/Anna_Mani
    "mani",
    ...
    "yash_pal",
    # Demis Hassabis - British AI researcher and co-founder of DeepMind; 2024 Nobel Prize in Chemistry for AlphaFold protein structure prediction. https://en.wikipedia.org/wiki/Demis_Hassabis
    "hassabis",
    # John Jumper - American AI researcher at Meta; 2024 Nobel Prize in Chemistry for developing AlphaFold2. https://en.wikipedia.org/wiki/John_Jumper
    "jumper",
    ...
    "cantor",
    # David Hilbert - German mathematician; formulated the influential Hilbert's 23 problems. https://en.wikipedia.org/wiki/David_Hilbert
    "hilbert",
    ...
    "hoyle",
    # Carl Woese - American microbiologist; discovered archaea, revolutionized understanding of life. https://en.wikipedia.org/wiki/Carl_Woese
    "woese",
    # Sydney Brenner - South African biologist; 2002 Nobel Prize in Physiology or Medicine for developmental biology. https://en.wikipedia.org/wiki/Sydney_Brenner
    "brenner",
